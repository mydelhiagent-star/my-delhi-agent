...
func (s *PropertyService) GetProperties(ctx context.Context, params models.PropertyQueryParams, fields []string) ([]models.Property, error) {
	params.SetDefaults()
	return s.Repo.GetProperties(ctx, params, fields)
}