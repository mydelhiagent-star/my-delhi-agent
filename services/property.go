...
func (s *PropertyService) GetProperties(ctx context.Context, params models.PropertyQueryParams, page, limit int) ([]models.Property, error) {
	return s.Repo.GetProperties(ctx, params, page, limit)
}